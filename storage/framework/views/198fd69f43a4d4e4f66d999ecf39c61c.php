...
<div class="row">
    ...
    <div id="reminders-section">
        ...
        <div id="reminders-list">
            ...
            <div class="reminder-card" id="reminder-<?php echo e($reminder->id); ?>">
        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card tale-bg">
                <div class="card-people mt-auto">
                    <img src="<?php echo e(asset('assets/images/dashboard/people.svg')); ?>" alt="people">
                    <div class="weather-info">
                        <div class="d-flex">
                            <div>
                                <h2 class="mb-0 font-weight-normal">
                                    <i class="icon-sun mr-2"></i>
                                    <span id="temp"><?php echo e($temp); ?></span><sup>C</sup>
                                </h2>
                            </div>
                            <div class="ml-2">
                                <h4 class="location font-weight-normal" id="city"><?php echo e($city); ?></h4>
                                <h6 class="font-weight-normal" id="country"><?php echo e($country); ?></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-tale">
                        <div class="card-body">
                            ...
                            <p class="fs-30 mb-2"><?php echo e($totalAgencyUsers); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                    <div class="card card-dark-blue">
                        <div class="card-body">
                            ...
                            <p class="fs-30 mb-2"><?php echo e($totalLeads); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                    <div class="card card-light-blue">
                        <div class="card-body">
                            ...
                            <p class="fs-30 mb-2"><?php echo e($pendingLeads); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 stretch-card transparent">
                    <div class="card card-light-danger">
                        <div class="card-body">
                            ...
                            <p class="fs-30 mb-2"><?php echo e($completedLeads); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4 stretch-card grid-margin">
            ...
            <div class="card-body">
                ...
                <li>
                    <div class="d-flex">
                    <img src="<?php echo e(asset('assets/images/faces/face1.jpg')); ?>" alt="user">
                    <div>
                ...
                <li>
                    <div class="d-flex">
                    <img src="<?php echo e(asset('assets/images/faces/face2.jpg')); ?>" alt="user">
                    <div>
                ...
                <li>
                    <div class="d-flex">
                    <img src="<?php echo e(asset('assets/images/faces/face3.jpg')); ?>" alt="user">
                    <div>
                ...
                <li>
                    <div class="d-flex">
                    <img src="<?php echo e(asset('assets/images/faces/face4.jpg')); ?>" alt="user">
                    <div>
                ...
                <li>
                    <div class="d-flex">
                    <img src="<?php echo e(asset('assets/images/faces/face5.jpg')); ?>" alt="user">
                    <div>
